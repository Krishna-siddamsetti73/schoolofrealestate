...
import { Lightbulb, Briefcase, DollarSign, Award, Target, MapPin } from 'lucide-react';
...
const WhyChooseUs = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#FAF6EF] to-white relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-[#2F3542] mb-4 font-poppins">
            {t("why.title.part1")} <span className="text-[#1E3A8A]">{t("why.title.part2")}</span>
          </h2>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-[#1E3A8A] h-full">
                ...
                <h3 className="text-xl font-bold text-[#2F3542] mb-3 text-center group-hover:text-[#1E3A8A] transition-colors">
                  {feature.title}
                </h3>
